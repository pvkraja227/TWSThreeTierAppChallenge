...
eksctl create iamserviceaccount --cluster=three-tier-cluster --namespace=kube-system --name=aws-load-balancer-controller --role-name AmazonEKSLoadBalancerControllerRoleForEKS --attach-policy-arn=arn:aws:iam::024235468536:policy/AWSLoadBalancerControllerIAMPolicyForEKS --approve --region=ap-south-1
```
